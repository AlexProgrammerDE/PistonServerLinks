    ...
    filesMatching(
      ...
      expand(
        mapOf(
          ...
          "url" to "https://modrinth.com/plugin/pistonserverlinks",
        )
      )
    }
  }
  ...
  publications {
    register<MavenPublication>("mavenJava") {
      ...
      pom {
        ...
        scm {
          connection = "scm:git:https://github.com/AlexProgrammerDE/PistonServerLinks.git"
          developerConnection = "scm:git:ssh://git@github.com/AlexProgrammerDE/PistonServerLinks.git"
          url = "https://github.com/AlexProgrammerDE/PistonServerLinks"
        }
        ciManagement {
          system = "GitHub Actions"
          url = "https://github.com/AlexProgrammerDE/PistonServerLinks/actions"
        }
        issueManagement {
          system = "GitHub"
          url = "https://github.com/AlexProgrammerDE/PistonServerLinks/issues"
        }
      }
    }
  }
